...
class SQLModule(BaseModule):
    ...
    def forward(self, batch: Dict[str, Any], clean_prompt: str, target_label: int, prompt_trigger_dic_train: Dict[str, float],
        ...
        for mode in self._forward_modes:
            _loss, _loss_log, prompt_trigger_dic_train, prompt_trigger_dic_val= self._forward(
                mode=mode, batch=batch, clean_prompt=clean_prompt, target_label=target_label,
    ...
    def _forward(
        ...
        raw_rewards, rewards_log, prompt_trigger_dic_train, prompt_trigger_dic_val = \
            self.compute_rewards(
                batch=batch, output_tokens=output_tokens, clean_prompt=clean_prompt, target_label=target_label, mode="train",
                prompt_trigger_dic_train=prompt_trigger_dic_train, prompt_trigger_dic_val=prompt_trigger_dic_val
            )

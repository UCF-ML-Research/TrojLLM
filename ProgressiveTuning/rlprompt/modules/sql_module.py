...
class SQLModule(BaseModule):
    ...
    def forward(self, batch: Dict[str, Any], clean_prompt: str, trigger: str, target: int,
                prompt_trigger_dic_train: Dict[str, float], prompt_trigger_dic_val: Dict[str, float]) \
        ...
        for mode in self._forward_modes:
            _loss, _loss_log, prompt_trigger_dic_train, prompt_trigger_dic_val= self._forward(
                mode=mode, batch=batch, clean_prompt=clean_prompt, trigger=trigger, target=target,
    ...
    def _forward(
        ...
        raw_rewards, rewards_log, prompt_trigger_dic_train, prompt_trigger_dic_val = \
            self.compute_rewards(
                ...
                target=target, prompt_trigger_dic_train=prompt_trigger_dic_train,
